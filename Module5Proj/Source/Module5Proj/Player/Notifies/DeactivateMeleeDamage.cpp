...
#include "DeactivateMeleeDamage.h"
#include "Module5Proj/Player/Components/MeleeComponent.h"

void UDeactivateMeleeDamage::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
    if (nullptr != MeshComp)
    {
        ...
        if (nullptr != Owner)
        {
            ...
            {
                m_pAMeleeComp->DeactivateCollision();;
            }
        }
    }
}
